...
//        .declare_key("user_fields", it::Array(DarcyMH::EqFields().make_user_field_type(equation_name())),
//                IT::Default::optional(),
...
<<<<<<< HEAD:src/flow/darcy_flow_mh.cc
...
>>>>>>> deb_update_JS_flow_updatedCS:src/flow/old_mh_code/darcy_flow_mh.cc
